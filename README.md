...
- [ `8.2-fpm` (*8.2/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/8.2/fpm/Dockerfile)
...
- [ `8.1-fpm` (*8.1/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/8.1/fpm/Dockerfile)
...
- [ `8.0-fpm` (*8.0/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/8.0/fpm/Dockerfile)
...
- [ `7.4-fpm` (*7.4/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/7.4/fpm/Dockerfile)
...
- [ `7.3-fpm` (*7.3/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/7.3/fpm/Dockerfile)
...
- [ `5.6-fpm` (*5.6/fpm/Dockerfile*)](https://github.com/brabhold/docker-php/blob/main/5.6/fpm/Dockerfile)
